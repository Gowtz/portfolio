            ...
            <nav className="h-20 w-10/12 m-auto flex justify-between items-center mt-52 ">
                ...
                <div className="social__media flex items-center">
                    <ul className="flex gap-4 items-center ">
                        ...
                        <li className="hover:bg-blue-900 p-2 rounded-2xl ease-in duration-200"><a href="https://github.com/gowtz"><Image src="/social/Github.png" alt="GitHub" width={size} height={size} /></a></li>
